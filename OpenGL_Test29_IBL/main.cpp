...
int main()
{
    ...
    string p9 = string(headDir) + "LightShader/Prefilter.vs";
    string p10 = string(headDir) + "LightShader/Prefilter.fs";
    Shader prefilterShader(p9.c_str(), p10.c_str());
    string p11 = string(headDir) + "LightShader/BRDF.vs";
    string p12 = string(headDir) + "LightShader/BRDF.fs";
    Shader brdfShader(p11.c_str(), p12.c_str());
